    ...
    <body id="content" class="container-fluid">
        ...
        <div class="row">
            ...
            <div id="homeNav" class="col-sm-8 col-md-8 col-lg-8">
                ...
                <input id="createbtn" type="submit" value="Create New"/>
                <input id="logoutbtn" name="logout" type="submit" value= "logout" />
                
            </div>
        </div>
        <div id= "section">
            <div id="create" class="createSection" style="display:none">
                <div id="emailStrip">Email: <input id="email" type="text" name="email"/></div>
                <div>First Name: <input id="fname" type="text" name="firstname"/></div>
                <div>Last Name: <input id="lname" type="text" name="lastname"/></div>
                <div>Username: <input id="uname" type="text" name="username"/></div>
                <div id="idStrip">Password: <input id="pswrd" type="password" name="password"/></div>
                <div><input id="addUser" type="submit" value="Add User"/></div>
            </div>
